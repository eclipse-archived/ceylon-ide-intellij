...
public class CeylonMultiplicativeExpressionImpl extends CeylonCompositeElementImpl implements CeylonMultiplicativeExpression {

  public CeylonMultiplicativeExpressionImpl(ASTNode node) {
    super(node);
  }
  ...
  public List<CeylonDefaultExpression> getDefaultExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CeylonDefaultExpression.class);
  }
