...
public class CeylonNonemptyConditionImpl extends CeylonCompositeElementImpl implements CeylonNonemptyCondition {

  public CeylonNonemptyConditionImpl(ASTNode node) {
    super(node);
  }
