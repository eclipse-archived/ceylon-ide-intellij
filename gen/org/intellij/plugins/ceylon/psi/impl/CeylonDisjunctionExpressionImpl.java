...
public class CeylonDisjunctionExpressionImpl extends CeylonCompositeElementImpl implements CeylonDisjunctionExpression {

  public CeylonDisjunctionExpressionImpl(ASTNode node) {
    super(node);
  }
  ...
  public List<CeylonConjunctionExpression> getConjunctionExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CeylonConjunctionExpression.class);
  }
