...
import org.intellij.plugins.ceylon.ide.psi.ceylonFileFactory_;
import org.intellij.plugins.ceylon.ide.psi.impl.DeclarationPsiNameIdOwner;
...
public class CeylonAddFileAction extends CreateFromTemplateAction<PsiElement> {
    ...
    public CeylonAddFileAction() {
        super("", message("ceylon.file.wizard.title"), icons.getNewFile());
    }
    ...
    protected void buildDialog(Project project, PsiDirectory directory, CreateFileFromTemplateDialog.Builder builder) {
        builder
                ...
                .addKind("File", icons.getNewFile(), "unit")
