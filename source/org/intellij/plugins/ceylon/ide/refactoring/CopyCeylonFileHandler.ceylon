...
"By default, IntelliJ tries to find PsiClasses to rename in the copy refactoring. This
 class makes sure it's also possible to rename Ceylon *files* that don't contain PsiClasses
