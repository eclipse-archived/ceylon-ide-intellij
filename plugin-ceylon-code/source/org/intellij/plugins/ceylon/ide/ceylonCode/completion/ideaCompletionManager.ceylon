...
shared object ideaCompletionManager extends IdeCompletionManager<LookupElement>() {
    ...
    shared actual LookupElement newRefinementCompletionProposal(Integer offset, String prefix,
        Reference? pr, String desc, String text, LocalAnalysisResult data,
    ...
    shared actual LookupElement newCurrentPackageProposal(Integer offset, String prefix, String packageName, LocalAnalysisResult data) {
    ...
    shared actual LookupElement newImportedModulePackageProposal(Integer offset, String prefix,
        ...
        String fullPackageName, LocalAnalysisResult data,
        Package candidate) {
    ...
    shared actual LookupElement newModuleProposal(Integer offset, String prefix, Integer len, 
        ...
        ModuleVersionDetails version, String name, Node node, LocalAnalysisResult data) {
    ...
    shared actual LookupElement newParameterInfo(Integer offset, Declaration dec, 
        Reference producedReference, Scope scope, LocalAnalysisResult data, Boolean namedInvocation) => nothing;

    shared actual LookupElement newFunctionCompletionProposal(Integer offset, String prefix,
        String desc, String text, Declaration dec, Unit unit, LocalAnalysisResult data) {
    ...
    shared actual LookupElement newControlStructureCompletionProposal(Integer offset,
        ...
        LocalAnalysisResult data, Node? node) {
