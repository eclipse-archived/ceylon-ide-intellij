...
public class IdeaCeylonParser extends IStubFileElementType {
    ...
    protected ASTNode doParseContents(@NotNull ASTNode chameleon, @NotNull PsiElement psi) {
        ...
        try {
            ...
            ExternalPhasedUnit externalPu = findExternalPhasedUnit(file);
            if (externalPu != null) {
                Tree.CompilationUnit externalCompilationUnit = externalPu.getCompilationUnit();
                ASTNode root = translator.translateToAstNode(externalCompilationUnit);
    ...
    private ExternalPhasedUnit findExternalPhasedUnit(CeylonFile file) {
