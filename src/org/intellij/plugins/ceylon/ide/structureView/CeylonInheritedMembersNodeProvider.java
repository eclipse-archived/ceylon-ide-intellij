...
class CeylonInheritedMembersNodeProvider extends InheritedMembersNodeProvider
        ...
        if (node instanceof PsiTreeElementBase) {
            ...
            if (element instanceof CeylonPsi.DeclarationPsi) {
                ...
                if (declaration instanceof Tree.ObjectDefinition) {
                    Value model = ((Tree.ObjectDefinition) declaration).getDeclarationModel();
                    type = model == null ? null : model.getTypeDeclaration();
    ...
    private List<TreeElement> scanMembers(PsiElement element, Tree.Declaration declaration, TypeDeclaration type) {
